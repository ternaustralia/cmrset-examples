...
def download_file(url, output):
    ...
    #    "File does not appear to exist on server:"
    #    $url
    #    continue
    #}
    #return $true
...
def download_images(base_url, base_folder, relative_paths):
    ...
    for relative_path in relative_paths:
        ...
        tile_ids = itemgetter(*TILES)(TileLookup)
...
def main():
    ...
    result = download_images(ProductCodes[PRODUCT_CODE], "{path_out}/{product_code}".format(path_out=PATH_OUT,product_code=PRODUCT_CODE), vrt_relative_paths)
    logging.info(result)
